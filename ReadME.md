...
The parameters you typically want to modify is *reference_genome*, *blat_path*, *gene_bed* and *exon_bed*.
For other parameters, the default setting is mainly for 100bp-length paired read data.
